      ...
      try {
        ...
        if (found) {
          ...
          if (found.matrix_data) {
             ...
             // Fallback if matrix_data is missing but reviewJsonId exists?
             // Assuming migration is complete, we stick to matrix_data
             // If completely missing, use default empty content
          }
